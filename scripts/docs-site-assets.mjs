...
:root{
  ...
  --accent-strong:#962f23;
  --g-blue:#c2412f;--g-red:#111827;--g-yellow:#b7ff00;--g-green:#7c3aed;
  --line:#e5e7eb;
  --line-soft:#eef0f3;
  --code-bg:#0f172a;
  --code-fg:#e6edf3;
...
:root[data-theme="dark"]{
  ...
  --paper:#171a23;
  --accent:#ff705c;
  --accent-soft:rgba(255,112,92,.16);
...
.home-product{display:flex;align-items:center;gap:14px;margin:0 0 18px;color:var(--ink);font-size:1.35rem;font-weight:700;letter-spacing:0}
.home-product-mark{font-size:1.55em;line-height:1}
...
.doc pre .hl-url{color:var(--hl-string)}
...
export function faviconSvg() {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" role="img" aria-label="gifgrep">
<rect width="64" height="64" rx="12" fill="#0f1115"/>
<path d="M20 38V24a12 12 0 0 1 24 0v14h-9V24a3 3 0 0 0-6 0v14z" fill="#ff705c"/>
<rect x="14" y="38" width="15" height="9" rx="3" fill="#b7ff00"/>
<rect x="35" y="38" width="15" height="9" rx="3" fill="#7c3aed"/>
</svg>`;
}
